...
const Teacher = () => {
  ...
  const handleClose = () => {
    ...
    setloading(true);
    axios.post("https://backend-lk64.onrender.com/creatteacher", {
      ...
      .then(() => {
        ...
        setShow(false);
        setUpdate(false);
        axios.get("https://backend-lk64.onrender.com/allteacher")
  ...
  const handleCloseForUpdate = () => {
    ...
    setloading(true);
    axios.patch(`https://backend-lk64.onrender.com/teacher/${teacherObjectId}`, {
      teachername: teachername,
      departmentname: departmentname,
      phonenumber: phonenumber,
    })
  ...
  const handleShowModal = (id) => {
    setUpdate(true);
    axios.get(`https://backend-lk64.onrender.com/teacher/${id}`).then((data) => {
  ...
  let handleDelete = async (id) => {
    try {
      await axios.post("https://backend-lk64.onrender.com/deleteTeacher", { id });
      const { data } = await axios.get("https://backend-lk64.onrender.com/allteacher");
      setteacherList(data);
    } catch (err) {
      console.log(err);
    }
